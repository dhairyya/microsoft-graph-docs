...
<!-- { "blockType": "permissions", "name": "authentication_list_passwordmethods" } -->
[!INCLUDE [permissions-table](../includes/permissions/authentication-list-passwordmethods-permissions.md)]
